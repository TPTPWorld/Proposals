...
thf(nofp_type, type, (nofp : ((fin @ (suc @ zero)) > (fin @ (suc @ zero))))).
thf(nofp_def, definition, (nofp = (^ [X: (fin @ (suc @ zero))] : (@+ [Y: (fin @ (suc @ zero))] : (X != Y))))).

thf(dchoice_nofp_fin1, conjecture, (! [X:(fin @ (suc @ zero))] : ((nofp @ X) != X))).
%------------------------------------------------------------------------------

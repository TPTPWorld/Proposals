...
thf(nofp_type, type, (nofp : ((fin @ (suc @ (suc @ (suc @ zero)))) > (fin @ (suc @ (suc @ (suc @ zero))))))).
thf(nofp_def, definition, (nofp = (^ [X: (fin @ (suc @ (suc @ (suc @ zero))))] : (@+ [Y: (fin @ (suc @ (suc @ (suc @ zero))))] : (X != Y))))).

thf(dchoice_nofp_fin3, conjecture, (! [X:(fin @ (suc @ (suc @ (suc @ zero))))] : ((nofp @ X) != X))).
%------------------------------------------------------------------------------
